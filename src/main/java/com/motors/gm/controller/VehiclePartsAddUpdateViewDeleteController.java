...
import com.motors.gm.service.VehiclePartsAddUpdateViewService;
...
public class VehiclePartsAddUpdateViewDeleteController {
	...
	@Autowired
	VehiclePartsAddUpdateViewService vehiclePartsAddUpdateViewService;

	
	@PostMapping(path = "/addVehicleParts", produces = "application/json")
	public String save(@RequestBody VehicleParts vehicleParts) {
		vehiclePartsAddUpdateViewService.saveVehicleParts(vehicleParts);
		return "Save Parts Success";
	}

	
	  @PutMapping(path="/updateVehicle/{regNumber}", produces ="application/json") 
	  public String update(@RequestBody VehicleParts
			  vehicleParts, @PathVariable String regNumber) {
		  vehiclePartsAddUpdateViewService.updateVehicleParts(vehicleParts, regNumber); return
	  "Update Success"; }
	  
	  @DeleteMapping(path="/deleteVehicle/{regNumber}", produces =
	  "application/json") public String deleteVehicle(@PathVariable String
	  regNumber) { return vehiclePartsAddUpdateViewService.deleteVehicleParts(regNumber); }
